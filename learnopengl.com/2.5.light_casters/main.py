...
class App(xglut.GLFWViewer):
    ...
    def draw(self):
        ...
        normal_mat = model_rot_mat.T @ np.linalg.inv(model_rot_mat)
        mvp_mat = projection_mat @ view @ model_mat
        
        
        self.cube_shader.use()
        self.cube_shader.set_uniform("ModelMatrix", model_mat)
        self.cube_shader.set_uniform("ModelViewProjectionMatrix", mvp_mat)
        self.cube_shader.set_uniform("NormalMatrix", normal_mat)
        self.cube_shader.set_uniform("material.diffuse", 0)
        self.cube_shader.set_uniform("material.specular", 1)
        self.cube_shader.set_uniform("material.shininess", 64.0)
        ...
        self.cube_shader.set_uniform("light.ambient",[0.2,0.2,0.2])
        self.cube_shader.set_uniform("light.diffuse", [0.5,0.5,0.5])
        self.cube_shader.set_uniform("light.specular",[1.0,1.0,1.0])
